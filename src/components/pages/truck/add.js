      ...
      >
        ...
        <DialogContent style={{ paddingTop : 20}}>
          <Grid container alignContent="center" alignItems="center" direction="column" spacing={2}>
              ...
              {/* <Grid item  className = { classes.fullWidth}>
                  <FormControl  className = { classes.fullWidth}>
                    <TextField variant="outlined" label="Vehicle Type" {...register(`vehicle_type`,{ required: true })}/>
                    { errors?.vehicle_type  && <p style={ hStyle }>Vehicle Type is required</p>}
                  </FormControl>
              </Grid> */}
              ...
              {/* <Grid item  className = { classes.fullWidth}>
                  <FormControl  className = { classes.fullWidth}>
                    <TextField variant="outlined" label="Year" {...register(`year`,{ required: true })}/>
                    { errors?.year  && <p style={ hStyle }>Year is required</p>}
                  </FormControl>
              </Grid> */}
              ...
              {/* <Grid item  className = { classes.fullWidth}>
                  <FormControl  className = { classes.fullWidth}>
                    <TextField variant="outlined" label="Owned By" {...register(`owned_by`,{ required: true })}/>
                    { errors?.owned_by  && <p style={ hStyle }>Owned By is required</p>}
                  </FormControl>
              </Grid> */}

              {/* <Grid item  className = { classes.fullWidth}>
                  <FormControl  className = { classes.fullWidth}>
                    <TextField variant="outlined" label="Registration Expire" {...register(`registration_expiry`,{ required: true })}/>
                    { errors?.registration_expiry  && <p style={ hStyle }>Registration Expire is required</p>}
                  </FormControl>
              </Grid> */}
              ...
              <Grid item  className = { classes.fullWidth}>
                  <FormControl  className = { classes.fullWidth}>
                    <TextField variant="outlined" label="Default Driver" {...register(`default_driver`,{ required: true })}/>
                    { errors?.default_driver  && <p style={ hStyle }>Default Driver is required</p>}
                  </FormControl>
              </Grid>
              ...
              <Grid item className = { classes.fullWidth}>
                  <FormControl  className = { classes.fullWidth}>
                          <InputLabel id="demo-simple-select-helper-label">Owned By</InputLabel>
                              ...
                              { users.map(e=>(
                              <MenuItem value={e._id}>{e.email}</MenuItem>
                              ))}
                              </Select>
                              </FormControl>
                              {errors.user && <p>User is required</p>}
