...
export default function Index() {
    ...
    const [columnDefs] = useState([
        { field: 'first_name' , filter: true , headerName: 'First name' , ...columnCentered},
        { field: 'last_name' , filter: true, headerName: 'Last name' , ...columnCentered},
        { field: 'email', headerName: 'email' , ...columnCentered },
        { field: 'designation.designation' , headerName: 'Designation' , ...columnCentered},
        { field: 'role.slug' , headerName: 'Role' , ...columnCentered},
        { field: 'createdAt' , headerName: 'createdAt' , ...columnCentered},
          ...
          const dataSource = {
            getRows: (params) => {
              ...
              const page = params.startRow === 0 ? 0 : params.startRow ;
                 axios.get(`${process.env.REACT_APP_BASE_URL}/getusers?$skip=${page}`)
                .then(res => {
